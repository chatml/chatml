...
export function createConductorMcpServer(options) {
    ...
    return createSdkMcpServer({
        ...
        tools: [
            // Session status tool
            tool("get_session_status", "Get current session status including branch, worktree, and active Linear issue", {}, async () => {
            ...
            // Workspace diff tool
            tool("get_workspace_diff", "Get a summary of all changes in the workspace compared to the base branch", {
            ...
            tool("get_recent_activity", "Get recent commits and file changes in the workspace", {
