...
- Learn about [Workspaces](/docs/core-concepts/workspaces) and [Sessions](/docs/core-concepts/sessions-worktrees) in depth
- Explore [Skills](/docs/ai-agent/skills) to augment Claude's capabilities
- Set up [GitHub integration](/docs/integrations/github) for PR and CI features
- Configure [budget controls](/docs/ai-agent/budget-controls) to manage costs
