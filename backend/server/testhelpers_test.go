...
func setupTestHandlers(t *testing.T) (*Handlers, *store.SQLiteStore) {
	...
	handlers := NewHandlers(context.Background(), sqliteStore, nil, DirListingCacheConfig{TTL: 30 * time.Second}, nil, nil, nil, nil, prCache, nil, nil, nil, nil, nil, nil, nil, nil)
...
func setupTestHandlersWithAgentManager(t *testing.T) (*Handlers, *store.SQLiteStore, *agent.Manager) {
	...
	handlers := NewHandlers(context.Background(), sqliteStore, agentManager, DirListingCacheConfig{TTL: 30 * time.Second}, nil, nil, nil, nil, prCache, nil, nil, nil, nil, nil, nil, nil, nil)
...
func setupTestHandlersWithAIClient(t *testing.T, aiServerURL string) (*Handlers, *store.SQLiteStore) {
	...
	handlers := NewHandlers(context.Background(), sqliteStore, nil, DirListingCacheConfig{TTL: 30 * time.Second}, nil, nil, nil, nil, prCache, nil, nil, nil, nil, aiClient, nil, nil, nil)
...
func setupTestHandlersWithGitHub(t *testing.T, ghServer *httptest.Server) (*Handlers, *store.SQLiteStore) {
	...
	handlers := NewHandlers(context.Background(), sqliteStore, nil, DirListingCacheConfig{TTL: 30 * time.Second}, nil, nil, nil, ghClient, prCache, nil, nil, nil, nil, nil, nil, nil, nil)
