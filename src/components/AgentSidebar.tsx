    ...
    <div className={cn('flex flex-col h-full', className)}>
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-normal text-foreground">Agents</span>
        </div>
        <button
          onClick={() => reloadAgents()}
          disabled={isLoading}
          className="p-1 rounded hover:bg-surface-2 text-muted-foreground hover:text-foreground disabled:opacity-50"
          title="Reload agents"
        >
