  ...
  return (
    <div className="space-y-2 pb-3">
      ...
      <div className="flex items-center gap-4">
        {/* Left side: Custom content and filter button */}
        ...
        {hasSearch && (
          <div className="relative flex-1 max-w-xl mx-auto">
            ...
            <input
              ...
              className="h-9 w-full rounded-md border border-border/50 bg-surface-1 pl-10 pr-9 text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-ring/50 focus:border-border transition-colors"
            />
            {searchValue && (
              <button
                type="button"
