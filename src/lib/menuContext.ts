...
export function computeMenuState(inputs: MenuContextInputs): Record<string, boolean> {
  ...
  return {
    ...
    review_quick: hasSession,
    review_deep: hasSession,
    review_security: hasSession,
    review_performance: hasSession,
    review_architecture: hasSession,
    review_premerge: hasSession,
